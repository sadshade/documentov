...
(function (global, factory) {
  ...
  var ui = {
    ...
    showDialog: function ($dialog) {
      ...
      //ПРАВКА - проблема диалога из-за fixed тулбара https://weblog.west-wind.com/posts/2016/sep/14/bootstrap-modal-dialog-showing-under-modal-background
  ...
  */
    ...
    Editor.prototype.insertImage = function (src, param) {
      ...
      return createImage(src, param).then(function ($image) {
        ...
        if (typeof param === 'function') {
          ...
          //$image.css('width', Math.min(_this.$editable.width(), $image.width()));ПРАВКА: ДОБАВЛЕНИЕ ШИРИНЫ ИЗОБРАЖЕНИЯ
        }
        $image.show();
  ...
  var CodeView = /** @class */ (function () {
    ...
    CodeView.prototype.activate = function () {
      var _this = this;
      // ПРАВКА: ДОБАВЛЕН TRIM 
      this.$codable.val($.trim(dom.html(this.$editable, this.options.prettifyHtml)));
      // КОНЕЦ ПРАВКИ
      ...
      if (env.hasCodeMirror) {
        ...
        //ПРАВКА: АВТОФОРМАТИРОВАНИЕ                             
        var totalLines = cmEditor_1.lineCount();
        var totalChars = cmEditor_1.getTextArea().value.length;
        cmEditor_1.autoFormatRange({ line: 0, ch: 0 }, { line: totalLines, ch: totalChars });
        //КОНЕЦ ПРАВКИ
  ...
  var ImagePopover = /** @class */ (function () {
    ...
    ImagePopover.prototype.update = function (target) {
      if (dom.isImg(target)) {
        ...
        this.$popover.css({
          display: 'block',
          //правка, ошибка в ФФ при вызове поповера - нет event
